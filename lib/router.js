...
const errorResult_1 = require("./result/errorResult");
        ...
        this.getController(controller)
            ...
            switch (req.method) {
                ...
                case 'GET':
                    ...
                    break;
                default:
                    new errorResult_1.ErrorResult(500, `Method not handled ${req.method}`).handle(res);
                    return;
            }
            ...
            if (handle) {
                ...
                if (methodParams.length === args.length) {
                    ...
                    new errorResult_1.ErrorResult(500, "Bad Request").handle(res);
                }
            }
            else {
                new errorResult_1.ErrorResult(404, "Route Not Found").handle(res);
                return;
            }
            result.handle(res);
        })
            .catch(err => {
            new errorResult_1.ErrorResult(500, "Error resolving controller").handle(res);
        });
    }

...
function HttpGet(options = {}) {
    return (target, propertyKey, descriptor) => {
        RegisterMethod(express_mvc_1.AllowedMethods[express_mvc_1.AllowedMethods.GET], options.route, target, propertyKey, options.parameters || "");
    };
}
...
function HttpPost(options = {}) {
    return (target, propertyKey, descriptor) => {
        RegisterMethod(express_mvc_1.AllowedMethods[express_mvc_1.AllowedMethods.POST], options.route, target, propertyKey, options.parameters || "");
    };
}
...
function HttpDelete(options = {}) {
    return (target, propertyKey, descriptor) => {
        RegisterMethod(express_mvc_1.AllowedMethods[express_mvc_1.AllowedMethods.DELETE], options.route, target, propertyKey, options.parameters || "");
    };
}
